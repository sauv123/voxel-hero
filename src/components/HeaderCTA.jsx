...
export default function HeaderCTA({ theme }) {
    ...
    return (
        <>
            ...
            >
                    {isMobile ? (
                        <div className="mobile-contact-fullscreen" style={{
                            position: 'fixed', inset: 0, background: '#000', zIndex: 999999,
                            display: 'flex', flexDirection: 'column', padding: '60px 24px',
                            transform: isOpen ? 'translateY(0)' : 'translateY(100%)',
                            transition: 'transform 0.5s cubic-bezier(0.16, 1, 0.3, 1)',
                            opacity: isOpen ? 1 : 0
                        }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '60px' }}>
                                <span style={{ color: '#fff', fontFamily: 'var(--font-heading)', fontSize: '24px', fontWeight: 'bold' }}>SAY HELLO.</span>
                                <button onClick={() => setIsOpen(false)} style={{ background: 'none', border: 'none', color: '#fff', fontSize: '32px', padding: 0 }}>&times;</button>
                            </div>
                            <div className="mobile-links" style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                                {[
                                    ...
                                    <a key={item.name} href={item.href} target={item.target || "_self"} style={{
                                        color: item.color, fontFamily: 'var(--font-heading)', fontSize: '48px', 
                                        fontWeight: 'bold', textDecoration: 'none', letterSpacing: '-0.02em',
                            ...
                            <div style={{ marginTop: 'auto', color: '#666', fontFamily: 'Space Mono, monospace', fontSize: '12px', textTransform: 'uppercase' }}>
                        ...
                        >
                            ...
                            {/* macOS Style Dock */}
                            <div className="macos-dock" onMouseLeave={handleDockLeave}>
                                {[
                                    ...
                                    { name: "Instagram", href: "https://www.instagram.com/sauveer.design/", color: "#E1306C", svg: <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/> },
                                    ...
                                    >
                                        ...
                                        <div className="dock-icon-box" style={{ background: item.color }}>
