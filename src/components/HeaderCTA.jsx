                ...
                >
                    ...
                    <div className="macos-dock" onMouseLeave={handleDockLeave}>
                        {[
                            ...
                            { name: "Resume", href: "/Resume - Sauveer.pdf", color: "#888", target: "_blank", svg: <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm-2 18H8v-2h4v2zm4-4H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/> }
                        ].map((item, i) => (
                            <a 
                                key={item.name}
                                href={item.href}
