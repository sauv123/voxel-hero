...
import TextLabShowcase, { TEXT_PROJECTS } from './OriginalTextLabShowcase';
...
export default function OriginalExperimentsGrid({ theme, disableScrollTrigger = false }) {
  ...
  return (
    ...
    >
      ...
      <div className="experiments-inner">
        {/* Header Section with elegant breathing space */}
        {!disableScrollTrigger && (
          <div ref={headingRef} className="experiments-title-box" style={{ marginBottom: '84px', marginTop: '48px' }}>
            <h2 className="experiments-title-main" style={{ 
              color: theme?.text || '#0d0d0d', 
              ...
              <span className="experiments-title-line">
                <span className="experiments-title-word">Products I've Built</span>
              </span>
            </h2>
          </div>
        )}

        {/* ── 1. PRIMARY TEXT HERO SHOWCASE (Lemon Notes, Blockchain Mosaic, Social Battery) ── */}
        <div style={{ marginBottom: '60px' }}>
          <TextLabShowcase 
            theme={theme} 
            showHeader={false}
            projects={TEXT_PROJECTS}
